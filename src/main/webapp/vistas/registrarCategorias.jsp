...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Menu Principal</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Frm_Categoria</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="srvCategoria?accion=${accion}" role="form" id="quickForm" method="POST">
                                        <input type="hidden" name="hCodigo" value="${categoria.codigo}">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Categoria</label>
                                                <input type="text" name="txtCategoria" value="${categoria.categoria}" required="" class="form-control" id="exampleInputEmail1" placeholder="Nombre Categoria">
                                            </div>
                                            <div class="form-group mb-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="chkEstado" ${categoria.estado ? 'checked' : 'unchecked' } class="custom-control-input" id="exampleCheck1">
                                                    <label class="custom-control-label" for="exampleCheck1">Estado Categoria.</label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
