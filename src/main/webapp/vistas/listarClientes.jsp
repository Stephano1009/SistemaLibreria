...
<html lang="en">
    <head>
        ...
        <title>Sistema Rosvil | Clientes</title>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                <a href="srvClientes?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Nueva Cliente</a>  
                            </div>
                            <div class="col-sm-6">
                                            ...
                                            <c:forEach var="cli" items="${clientes}" varStatus="iteracion">  
                                                <tr>
                                                    ...
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvClientes">
                                                               <c:param name="accion" value="editar" />
                                                               <c:param name="cod" value="${cli.codigo}" />
                                                           </c:url>">
                                                            <button type="button" class="btn btn-warning" data-toggle="tooltip" title="Editar" data-original-title="Editar">
                                                                <i class="fas fa-edit"></i></button>
                                                        </a>     
                                                        <input type="hidden" id="codigo" value="${cli.codigo}">        
                                                        <a id="deleteCategoria" href="<c:url value="srvClientes">
