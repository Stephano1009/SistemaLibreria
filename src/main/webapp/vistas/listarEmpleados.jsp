...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Empleados</title>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                <a href="srvEmpleados?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="emp" items="${empleado}" varStatus="iteracion">  
                                                <tr>
                                                    ...
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvEmpleados">
                                                               <c:param name="accion" value="editar" />
                                                               <c:param name="cod" value="${emp.codigoemp}" />
                                                           </c:url>">
                                                        ...
                                                        <input type="hidden" id="codigo" value="${emp.codigoemp}">        
                                                        <a id="deleteCategoria" href="<c:url value="srvEmpleados">
