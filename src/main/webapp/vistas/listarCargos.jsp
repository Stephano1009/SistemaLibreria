                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="srvCargo" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Sección Cargos</h1>
                                <a href="srvCargo?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Nuevo Cargo</a>  
                            </div>
                            <div class="col-sm-6">
                                            ...
                                            <c:forEach var="car" items="${cargo}" varStatus="iteracion">  
                                                <tr>
                                                    ...
                                                    <td class="text-center">                                                     
                                                        ...
                                                        <input type="hidden" id="codigo" value="${car.codigo}">        
                                                        <a id="deleteCategoria" href="<c:url value="srvCargo">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${car.isEstado() == true}">
                                                                <input type="hidden" id="item" value="${car.codigo}">
                                                                <a id="desactivarCate" href="srvCargo?cambiar=des&cod=${car.codigo}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar Estado" data-original-title="Desactivar">
                                                                    <i class="far fa-eye-slash"></i>
                                                                </a>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <input type="hidden" id="item" value="${car.codigo}">
                                                                <a id="activarCate" href="srvCargo?cambiar=act&cod=${car.codigo}" class="btn btn-primary" data-toggle="tooltip" title="Activar Estado" data-original-title="Activar">
