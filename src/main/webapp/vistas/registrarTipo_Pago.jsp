...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Registrar Tipo/Pago</title>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="srvTipo_Pago" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Sección Tipo/Pago</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Menu Principal</a></li>
                                    <li class="breadcrumb-item active">Frm_Tipo/Pago</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Registrar Tipo/Pago</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="srvTipo_Pago?accion=${accion}" role="form" id="quickForm" method="POST">
                                        <input type="hidden" name="hCodigo" value="${tipo_pago.codigopag}">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Tipo de Pago</label>
                                                        <input type="text" name="txtPago" value="${tipo_pago.nombretipopag}" required="" class="form-control" id="exampleInputEmail1" placeholder="Dígite el opcion de pago">
                                                    </div>                                                   
                                                    <div class="form-group mb-0" style="margin-top: 55px;">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" name="chkEstado" ${tipo_pago.estadopag ? 'checked' : 'unchecked' } class="custom-control-input" id="exampleCheck1">
                                                            <label class="custom-control-label" for="exampleCheck1">Estado Pago.</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <p>${msje}</p>
                                            <button type="submit" class="btn btn-primary">Registrar Opcion de Pago</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
