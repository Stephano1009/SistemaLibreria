...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Registrar Cargo</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Frm_Cargos</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="srvCargo?accion=${accion}" role="form" id="quickForm" method="POST">
                                        <input type="hidden" name="hCodigo" value="${cargo.codigo}">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nombre Cargo</label>
                                                <input type="text" name="txtCargo" value="${cargo.cargo}" required="" class="form-control" id="exampleInputEmail1" placeholder="Nombre Cargo">
                                            </div>
                                            <div class="form-group mb-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="chkEstado" ${cargo.estado ? 'checked' : 'unchecked' } class="custom-control-input" id="exampleCheck1">
                                                    <label class="custom-control-label" for="exampleCheck1">Estado Cargo</label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
