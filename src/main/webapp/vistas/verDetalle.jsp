...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Detalle Ventas</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Listado de Detalle de Ventas</h3>${msje}
                                    </div>
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="dv" items="${detalle}" varStatus="iteracion">  
                                                <tr>
                                                    <td>${iteracion.index + 1}</td>                                                 
                                                    <td>${dv.productos.nombrepro}</td>
                                                    <td>${dv.cantidadventas}</td>
                                                    <td>${dv.getPrecioventaventas()}</td>
                                                    <td>${dv.cantidadventas * dv.getPrecioventaventas()}</td>
                                                </tr>
                                            </c:forEach>  
                                        </table>
                                    </div>
