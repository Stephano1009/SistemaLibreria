                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                <a href="srvUsus?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Nueva Usuario</a>  
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="usus" items="${usuarios}" varStatus="iteracion">  
                                                <tr>
                                                    <td>${iteracion.index + 1}</td>
                                                    <td>${usus.usuario}</td>
                                                    <td>${usus.clave}</td>
                                                    <td>${usus.estado == true? 'Activo': 'Inactivo'}</td>                                                                                     
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvUsus">
                                                               <c:param name="accion" value="editar" />
                                                               <c:param name="cod" value="${usus.codigo}" />
                                                           </c:url>">
                                                        ...
                                                        <input type="hidden" id="codigo" value="${usus.codigo}">        
                                                        <a id="deleteCategoria" href="<c:url value="srvUsus">
