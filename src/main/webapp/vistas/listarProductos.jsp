...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Productos</title>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                <a href="srvProductos?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Nuevo Producto</a>  
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="pro" items="${productos}" varStatus="iteracion">  
                                                <tr>
                                                    <td>${iteracion.index + 1}</td>
                                                    <td>${pro.nombrepro}</td>
                                                    <td>${pro.stockpro}</td>
                                                    <td>${pro.estadopro == true ? 'activo': 'inactivo'}</td>
                                                    <td>${pro.descripcionpro}</td>
                                                    <td>${pro.contenidopro}</td>
                                                    <td>S/ ${pro.preciopro}0</td>
                                                    <td>${pro.categoriapro.categoria}</td>
                                                    <td>${pro.proveedorpro.nombreProve}</td>
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvProductos">
                                                               <c:param name="accion" value="editar" />
                                                               <c:param name="cod" value="${pro.codigopro}" />
                                                           </c:url>">
                                                        ...
                                                        <input type="hidden" id="codigo" value="${pro.codigopro}">        
                                                        <a id="deleteCategoria" href="<c:url value="srvProductos">
