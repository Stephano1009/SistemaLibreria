...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Registrar Usuarios</title>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="srvUsus" class="nav-link active">
                                            <i class="fas fa-users nav-icon"></i>
                                            <p>Usuarios</p>
                                        </a>
                                    </li>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Frm_Usuarios</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="srvUsus?accion=${accion}" role="form" id="quickForm" method="POST">
                                        <input type="hidden" name="hCodigo" value="${users.codigo}">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nombre Usuario</label>
                                                <input type="text" name="txtNombreUsuario" value="${users.usuario}" required="" class="form-control" id="exampleInputEmail1" placeholder="Nombre Usuario">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Clave Usuario</label>
                                                <input type="text" name="txtClaveUsuario" value="${users.clave}" required="" class="form-control" id="exampleInputEmail1" placeholder="Clave Usuario">
                                            </div> 
                                            <div class="form-group">
                                                        <label for="exampleInputEmail1">Seleccione un Cargo</label>
                                                        <select class="form-control" name="cboCargo">
                                                            <option value="0">Seleccione un Cargo</option>
                                                            <c:forEach items="${cargo}" var="car">
                                                                <option value="${car.codigo}"
                                                                        ${car.codigo == users.cargo.codigo ? "selected" : "" }
                                                                        >${car.cargo}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                            <div class="form-group mb-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="chkEstado" ${users.estado ? 'checked' : 'unchecked' } class="custom-control-input" id="exampleCheck1">
                                                    <label class="custom-control-label" for="exampleCheck1">Estado Usuario.</label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
