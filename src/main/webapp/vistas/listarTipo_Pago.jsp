...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Tipo_Pago</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Sección Tipos de Pago</h1>
                                <a href="srvTipo_Pago?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Nuevo Tipo de Pago</a>  
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Menu Principal</a></li>
                                    <li class="breadcrumb-item active">Tipo_Pago</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="tp" items="${Tipo_Pago}" varStatus="iteracion">  
                                                <tr>
                                                    <td>${iteracion.index + 1}</td>
                                                    <td>${tp.nombretipopag}</td>                                                 
                                                    <td>${tp.estadopag == true ? 'activo': 'inactivo'}</td>                                                  
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvTipo_Pago">
                                                               <c:param name="accion" value="editar" />
                                                               <c:param name="cod" value="${tp.codigopag}" />
                                                           </c:url>">
                                                        ...
                                                        <input type="hidden" id="codigo" value="${tp.codigopag}">        
                                                        <a id="deleteCategoria" href="<c:url value="srvTipo_Pago">
