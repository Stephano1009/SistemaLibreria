...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Proveedores</title>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                <a href="srvProveedores?accion=nuevo" style="margin-top: 10px;" class="btn btn-success">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="prove" items="${proveedores}" varStatus="iteracion">  
                                                <tr>
                                                    ...
                                                    <td>${prove.nombreProve}</td>
                                                    <td>${prove.rucProvee}</td>
                                                    <td>${prove.telefonoProve}</td>
                                                    <td>${prove.estadoProve == true? 'Activo': 'Inactivo'}</td>                                    
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvProveedores">
                                                               <c:param name="accion" value="editar" />
                                                               <c:param name="cod" value="${prove.codigoProve}" />
                                                           </c:url>">
                                                            <button type="button" class="btn btn-warning" data-toggle="tooltip" title="Editar" data-original-title="Editar">
                                                                <i class="fas fa-edit"></i></button>
                                                            <input type="hidden" id="codigo" value="${prove.codigoProve}">
                                                        </a>
                                                        <a id="deleteCategoria" href="<c:url value="srvProveedores">
