...
<html lang="en">
    <head>
        ...
        <title>Sistema Libreria | Registrar Clientes</title>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="srvClientes" class="nav-link active">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Frm_Clientes</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="srvClientes?accion=${accion}" role="form" id="quickForm" method="POST">
                                        <input type="hidden" name="hCodigo" value="${cliente.codigo}">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nombre Cliente</label>
                                                <input type="text" name="txtNombreCliente" value="${cliente.nombre}" required="" class="form-control" id="exampleInputEmail1" placeholder="Dígite el Nombre">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Apellido Cliente</label>
