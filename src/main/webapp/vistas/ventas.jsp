...
<html lang="en">
    <head>
        ...
        <title>Sistema Rosvil | Ventas</title>
    ...
    <body class="hold-transition sidebar-mini">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="srvVentas" class="nav-link active">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                                        ...
                                        <li class="breadcrumb-item active">Frm_Ventas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Generar Nueva Venta</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="srvVentas?accion=${accion}" role="form" id="form_venta" method="POST">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="cbocomprobante" required>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="cbotipopago" required>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="txtserie">N° Serie</label>
                                                        <input type="text" class="form-control" id="txtserie" readonly required name="txtserie">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="txtcorrelativo">N° Correlativo</label>
                                                        <input type="text" name="txtcorrelativo" readonly required class="form-control" id="txtcorrelativo">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div>
                                                        <label>Busque un producto</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <button type="button" id="btn_buscar" class="btn btn-warning"><i class="fas fa-search"></i> Buscar Producto</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" id="btn_agregar" class="btn btn-primary"><i class="fas fa-plus"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-xs-12">
                                                    ...
                                                    <input class="form-control" id="txtsubtotal" readonly>
                                                    <label>IGV</label>
                                                    <input class="form-control" id="txtigv" readonly>
                                                    <label>Total a Pagar</label>
                                                    <input class="form-control" id="txttotal" readonly>
                                                </div>
                                            </div>
                                            <!-- /.card-body -->
                                            <div class="card-footer" style="padding: unset;">
                                                ...
                                                <div class="form-inline">
                                                    <button type="submit" id="btn_registrar" class="btn btn-success"><i class="fas fa-print"></i> Registrar Venta </button>
                                                    <button type="reset" id="btn_cancelar" style="margin-left: 10px" class="btn btn-danger"><i class="fas fa-window-close"></i> Cancelar Venta</button>
                                                </div>
        ...
        <script src="js/funcionesVenta.js" type="text/javascript"></script>
