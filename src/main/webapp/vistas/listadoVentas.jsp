                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Listado de Ventas</h3>${msje}
                                    </div>
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <c:forEach var="v" items="${ventas}" varStatus="iteracion">  
                                                <tr>
                                                    <td>${iteracion.index + 1}</td>
                                                    <td class="text-center">${v.tipo_documentov == 'B' ? 'Boleta' : 'Inactivo'}</td>
                                                    <td>${v.fechav}</td>
                                                    <td>${v.empleados.nombreemp}</td>
                                                    <td>${v.clientes.nombre}</td>
                                                    <c:if test="${v.estado == true}">
                                                        <td class="text-center"><span class="badge bg-green active">Venta Activa</span></td> 
                                                    </c:if>
                                                    <c:if test="${v.estado == false}">
                                                    ...
                                                    <td class="text-center">                                                     
                                                        <a href="<c:url value="srvReportes">
                                                            ...
                                                            <button type="button" class="btn btn-warning" data-toggle="tooltip" title="Editar" data-original-title="Ver Detalle">
                                                                <i class="far fa-chart-bar"></i> Ver Detalle</button>
                                                        </a>                
                                                    </td>
                                                </tr>
                                            </c:forEach>  
